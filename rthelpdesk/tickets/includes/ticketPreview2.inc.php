...
<div class="ticketCluster">
    <div class="scroll1">
        <div class="scroll2">
            <div class="ticketFlags"><?php include("../tickets/includes/printFlags.inc.php") ?></div class="ticketFlags">
            <div class="ticketid"><?php echo("Ticket ID: " . $ticketid) ?></div>
            <table>
                <tr>
                    <td class="title">Subject</td>
                    <td class="notTitle"><?php echo($row['subject']) ?></td>
                </tr>
                <tr>  
                    <td class="title">Text</td>
                    <td class="notTitle"><?php echo($row['text']) ?></td>    
                </tr>
                <?php
                ...
                while($row2 = mysqli_fetch_assoc($result2)){
                    ...
                    $assignedAgentName = userIdIntoName($assignedAgentID);
                ...
                <tr>  
                    ...
                    <td class="notTitle">
                        <?php
                            if($assignedAgentName === $_SESSION["userinfo_nickname"]){
                                echo("Me");
                            }else{
                                echo($assignedAgentName);
                            }
                        ?>
                    </td>    
                </tr>
